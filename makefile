...
Libxbee: TransmitRequest ReceivePacket SerialXbee
	$(CXX) -shared -o $(BUILD_DIR)/libxbee_plus.so $(BUILD_DIR)/TransmitRequest.o $(BUILD_DIR)/ReceivePacket.o -lboost_system -lboost_thread -lpthread
...
Test1: 
	$(CXX) $(CXX_FLAGS) $(TEST_DIR)/main.cpp $(BUILD_DIR)/SerialXbee.o -o $(BUILD_DIR)/Test1 -L$(BUILD_DIR) -lboost_system -lboost_thread -lxbee_plus -lpthread
